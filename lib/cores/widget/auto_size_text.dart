...
class AutoSizeGroup {
  var _listeners = <_AutoSizeTextState, double>{};
    ...
    return LayoutBuilder(builder: (context, size) {
      ...
      if (style != null && maxLines != null) {
        ...
        if (widget.overflowReplacement != null && !textFits) {
          return widget.overflowReplacement ?? Container();
        } else {
          return text;
        }
      } else
